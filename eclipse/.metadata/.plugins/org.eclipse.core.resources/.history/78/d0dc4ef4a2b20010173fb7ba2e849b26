...
public class EBUHotspotMediaplayerActivity extends Activity {
    ...
    public void startVideoStream() {
    	...
    	String url = "rtsp://v3.cache7.c.youtube.com/CjYLENy73wIaLQnMYzt2FtQmqxMYESARFEIJbXYtZ29vZ2xlSARSBXdhdGNoYI6vr52RlLW1Sww=/0/0/0/video.3gp";
    ...
    public void startAudioStream() {
        ...
        String url = "http://10.73.141.81:8080";
